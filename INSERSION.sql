/*INGRESO ARTICULOS*/
insert into ARTICULO values (1001, 'Monitor AOC de 20″ LED con conectividad HDMI', 11, 110.00);
insert into ARTICULO values (1002, 'Lenovo V330 Core i5-8250U', 3, 990.00);
insert into ARTICULO values (1003, 'CASE ENCLOSURE DISCO DURO NOTEBOOK LAPTOP 2.5'' SATA USB 2.0', 14, 8.00);
insert into ARTICULO values (1004, 'DISCO SÓLIDO 120GB KINGSTON SSD', 31, 39.00);
insert into ARTICULO values (1005, 'Mouse HP Gaming M260', 27, 12.00);
insert into ARTICULO values (1006, 'Teclado Logitech K270 Inalámbrico', 26, 25.00);
insert into ARTICULO values (1007, 'Audifono + Microfono Gamer Xfire Xtratech Azul Y Negro Usb+ 2 Conectores 3.5Mm', 5, 19.64);
insert into ARTICULO values (1008, 'Teclado Logitech K400 + Wireless Touchpad Tv Cell Pc', 12, 40.00);
insert into ARTICULO values (1009, 'Cámara Web para PC', 22, 14.00);
insert into ARTICULO values (1010, 'Disco solido 1tb 1000gb crucial ssd', 14, 155.00);
...
/*INGRESO EMPLEADOS*/
insert into EMPLEADO values (1, 1, 1647815664, 'Eliana Cristina', 'Valle Ramirez', 'Femenino', 'Calle 15 av. 25', 0999543034, '05/10/1997');
insert into EMPLEADO values (2, 1, 1784452164, 'Martha Pamela', 'Arauz Aguayo', 'Femenino', 'Calle 10 av. 11', 0995482236, '13/06/1999');
insert into EMPLEADO values (3, 1, 1745120558, 'Gema Cecilia', 'Bazurto Quiroz', 'Femenino', 'Santa Martha calle 11 av. 34', 0968956789, '23/11/1998');
insert into EMPLEADO values (4, 1, 1877953032, 'Juan Anderson', 'Alava Hernandez', 'Masculino', 'La Aurora II', 0955887410, '25/11/1996');
insert into EMPLEADO values (5, 1, 1458726480, 'Bryan Gabriel', 'Arcentales Castillo', 'Masculino', 'Calle 13 av. 8', 0965487512, '13/07/2000');
insert into EMPLEADO values (6, 1, 1302995466, 'Raquel Amelia', 'Sanchez Alvia', 'Femenino', 'Cdla. las Cumbres', 0954875410, '26/09/2001');
insert into EMPLEADO values (7, 1, 1348756667, 'Martina Violeta', 'Acosta Espinales', 'Femenino', 'Urbanización Metróplis', 0948556820, '04/08/1997');
insert into EMPLEADO values (8, 1, 1353648795, 'Abel Daniel', 'Roldan Plua', 'Masculino', 'San Agustín calle A', 0968774859, '31/01/1995');
insert into EMPLEADO values (9, 2, 1478552220, 'Coraima Alejandra', 'Vera Navarrete', 'Femenino', 'Calle 11 av. 23', 0998572156, '14/01/1992');
insert into EMPLEADO values (10, 2, 1647845628, 'Marcos Steven', 'Saltos Gutierrez', 'Masculino', 'Los Geraneos', 0965441285, '18/05/1990');
insert into EMPLEADO values (11, 2, 1348448004, 'Jacinto Humberto', 'Arevalo Bravo', 'Masculino', 'Maria Auxiliadora calle 309 av. 209', 0958476698, '04/06/1995');
insert into EMPLEADO values (12, 2, 1784995642, 'Luis Renato', 'Rivas Paredes', 'Masculino', 'Calle 17 av. 21', 0935395489, '17/07/1995');
insert into EMPLEADO values (13, 2, 1254810202, 'Leonela Maria', 'Villamar Mejia', 'Femenino', 'La Pradera calle P5', 0947854122, '18/02/1991');
insert into EMPLEADO values (14, 2, 1895554584, 'Sergio Adam', 'Murillo Briones', 'Masculino', 'Nueva Esperanza', 0987458666, '24/12/1989');
/*INGRESO PROVEEDORES*/ 
...
/*INGRESO VENTAS*/
insert into VENTA values (1, 1317548954, 1, 122.00);
insert into VENTA values (2, 1722697441, 2, 103.64);
insert into VENTA values (3, 1701420570, 3, 209.00);
insert into VENTA values (4, 1311328114, 4, 442.25);
insert into VENTA values (5, 1697536715, 5, 879.00);
insert into VENTA values (6, 1487741126, 6, 246.99);
insert into VENTA values (7, 1317925956, 7, 548.00);
insert into VENTA values (8, 1154779629, 8, 123.79);
insert into VENTA values (9, 1784987441, 4, 216.96);
insert into VENTA values (10, 1317915842, 6, 586.61);
insert into VENTA values (11, 1177852487, 7, 520.27);
insert into VENTA values (12, 1549997452, 5, 103.46);
insert into VENTA values (13, 1309873279, 3, 161.10);
insert into VENTA values (14, 1348789954, 5, 325.90);
insert into VENTA values (15, 1124478965, 4, 990.00);
insert into VENTA values (16, 1458749961, 7, 308.00);
insert into VENTA values (17, 1314874168, 7, 265.00);
