...
create table EMPLEADO (
   ...
   EMPLEADO_FECHA_NACIMIENTO VARCHAR(30)                 not null,
...
create table LOTE (
   ...
   LOTE_FECHA_INGRESO   VARCHAR(100)           not null,
...
create table MANTENIMIENTO (
   ...
   MANTENIMIENTO_FECHA_INGRESO VARCHAR(100)                 not null,
   MANTENIMIENTO_FECHA_SALIDA VARCHAR(100)                 not null,
   ...
   MANTENIMENTO_DESCRIPCION	VARCHAR(100)         not null,
